...
export default function SiteFooter({ copy, shell, theme, language }) {
  ...
  return (
    <footer className={`border-t ${isDark ? 'border-[#2e3431]' : 'border-[#ded8cd]'} ${shell.page}`}>
      <div className="mx-auto grid max-w-7xl gap-8 px-5 py-10 md:grid-cols-[1.3fr_0.7fr_0.7fr]">
        <div>
      ...
      <div className={`border-t ${isDark ? 'border-[#2e3431]' : 'border-[#ded8cd]'}`}>
        <div className={`mx-auto flex max-w-7xl flex-col gap-2 px-5 py-4 text-xs font-bold md:flex-row md:items-center md:justify-between ${shell.muted}`}>
